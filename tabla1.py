...
################################################################################
## Form generated from reading UI file 'table_dialogGLlusG.ui'
##
...
class Ui_tabla(object):
    def setupUi(self, tabla):
        ...
        tabla.resize(648, 175)
        tabla.setStyleSheet(u"")
        self.gridLayoutWidget = QWidget(tabla)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(0, 0, 651, 171))
    ...
    def retranslateUi(self, tabla):
        ...
        ___qtablewidgetitem3.setText(QCoreApplication.translate("tabla", u"Dosis", None));
        ___qtablewidgetitem4 = self.tableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("tabla", u"fecha", None));
    # retranslateUi
